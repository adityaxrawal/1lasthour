    ...
    <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
      <div className="w-full lg:w-[55%]">
        ...
        <div className="flex items-center gap-2 text-[#666666] dark:text-slate-300 font-medium bg-[#F8F9FD] dark:bg-slate-800 py-2 px-4 rounded-full w-fit">
          ...
          <span>
            Effective Date: <span className="text-[#1E4FCD] dark:text-blue-400">June 5, 2026</span>
          </span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] hidden md:flex justify-center">
        ...
        <div className="relative w-72 h-80">
          <div className="absolute inset-0 bg-[#F8F9FD] dark:bg-slate-800 rounded-2xl border border-[#E8ECF4] dark:border-slate-700 shadow-[0_20px_50px_rgba(30,79,205,0.1)] dark:shadow-none transform rotate-3 flex flex-col p-6 overflow-hidden transition-colors duration-200">
            <div className="h-6 w-1/2 bg-[#E8ECF4] dark:bg-slate-700 rounded-md mb-8" />
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-sm bg-[#1E4FCD] dark:bg-blue-500 opacity-20" />
                <div className="h-3 w-full bg-[#E8ECF4] dark:bg-slate-700 rounded-sm" />
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-sm bg-[#1E4FCD] dark:bg-blue-500 opacity-20" />
                <div className="h-3 w-4/5 bg-[#E8ECF4] dark:bg-slate-700 rounded-sm" />
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-sm bg-[#1E4FCD] dark:bg-blue-500 opacity-20" />
                <div className="h-3 w-5/6 bg-[#E8ECF4] dark:bg-slate-700 rounded-sm" />
              </div>
            </div>
            {/* Badge decoration */}
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#1E4FCD] dark:bg-blue-500 rounded-full opacity-10 blur-xl" />
          </div>
          {/* Floating Shield */}

  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between rounded-3xl overflow-hidden mb-12 px-8 md:px-12 lg:px-16">
      <div className="w-full md:w-[45%] flex flex-col items-start z-10">
        <span className="inline-block text-[11px] font-semibold tracking-[0.5px] rounded-full mb-6 bg-[#eef4ff] text-[#3563ff] dark:bg-blue-900/30 dark:text-blue-400 px-3 py-1.5">
          LEGAL
        </span>

        <h1 className="text-[40px] md:text-[64px] font-[800] leading-[1.05] tracking-[-1.5px] mb-6 text-[#08245c] dark:text-white">
          Terms and Conditions
        </h1>

        <p className="text-[18px] leading-[1.8] max-w-[480px] text-[#6b7280] dark:text-slate-300">
          Please read these terms and conditions carefully before using 1LastHour. By accessing or
      ...
      <div className="w-full md:w-[55%] flex justify-center md:justify-end relative z-10 min-h-[300px]">
        ...
        <div className="relative w-[320px] h-[320px] md:w-[400px] md:h-[400px] flex items-center justify-center">
          ...
          <div className="absolute w-[280px] h-[280px] md:w-[360px] md:h-[360px] rounded-full opacity-60 mix-blend-multiply filter blur-3xl bg-gradient-to-br from-[#dbe4ff] to-[#eef2ff] dark:from-blue-900/20 dark:to-indigo-900/20" />
          <div className="absolute w-[240px] h-[240px] md:w-[300px] md:h-[300px] rounded-full right-0 top-0 opacity-40 mix-blend-multiply filter blur-2xl bg-gradient-to-br from-[#ffe4d6] to-[#fff0e6] dark:from-orange-900/20 dark:to-red-900/20" />

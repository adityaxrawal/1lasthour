...
export const termsData = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          1LastHour provides a platform for CFA candidates to access study materials, practice
          questions, mock exams, and performance analytics (collectively, the "Service").
        </p>
        <p>
          We reserve the right to modify, suspend, or discontinue the Service at any time, with or
          without notice to you. We will not be liable to you or any third party for any
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          1LastHour is an independent preparation service and is not affiliated with, endorsed by,
          or sponsored by the CFA Institute.
        </p>
        <p>
          CFA Institute, CFA®, and Chartered Financial Analyst® are trademarks owned by CFA
          Institute. Use of these marks on our platform is solely for the purpose of identifying the
          exam for which our materials are designed to help candidates prepare.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2 text-[#2f6cff] dark:text-blue-400 marker:text-[#2f6cff] dark:marker:text-blue-400">
          <li>
            <span className="text-[#667085] dark:text-slate-300">
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          exclusive property of 1LastHour and its licensors. Our materials are protected by
          copyright, trademark, and other laws.
        </p>
        <p>You are explicitly restricted from all of the following:</p>
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          Policy, which explains how we collect, use, and share information about you.
        </p>
        <p>
          By using the Service, you consent to the collection and use of this information in
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          The materials provided by 1LastHour are for educational and exam preparation purposes
          only. They do not constitute financial, investment, legal, or tax advice.
        </p>
        <p>
          We do not guarantee the accuracy, completeness, or usefulness of any information on the
          Service, and you rely on such information strictly at your own risk.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          1LastHour makes no representations or warranties of any kind, express or implied, as to
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          In no event shall 1LastHour, nor its directors, employees, partners, agents, suppliers, or
        ...
        <p>
          ...
          tort, negligence, strict liability, or any other basis, even if 1LastHour has been advised
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          continuing to access or use our Service after any revisions become effective, you agree to
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          Email:{' '}
          <a
            href="mailto:legal@1lasthour.com"
            className="text-[#2f6cff] dark:text-blue-400 hover:underline"
          >
            legal@1lasthour.com
          </a>
        </p>
